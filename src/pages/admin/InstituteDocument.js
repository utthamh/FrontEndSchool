...
import InstituteDocForm from '../../forms/InstituteDoc/InstituteDocForm'
export default function InstituteDocument() {
    return (<>
        <div className="card">
        <div className="card-header d-flex justify-content-between align-items-baseline">
          <h4 className="card-title">Institute Document</h4>
          <AddButton className={'btn btn-primary'} data-toggle="modal" data-target="#modelId"/>
      ...
      <Modal title={'Add Institute Document'} size={'lg'}>
      <InstituteDocForm/>
    </Modal>
      </>
    )
